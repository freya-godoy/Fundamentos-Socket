...
var divformEnviar = $("#divformEnviar");
var divtxtMensaje = $("#divtxtMensaje");
...
divformEnviar.on("submit", function (e) {
  e.preventDefault();
  if (divtxtMensaje.val().trim().length === 0) {
    return;
  }
  // Enviar información
  socket.emit(
    ...
    {
      nombre: nombre,
      mensaje: divtxtMensaje.val(),
    },
    function (mensaje) {
      divtxtMensaje.val("").focus();
